...
final class ScheduleController extends AbstractController
{
    ...
    public function index(ScheduleRepository $scheduleRepository): Response
    {
        ...
        return $this->render('schedule/index.html.twig', [
            'schedules' => $scheduleRepository->findByUser($user),
        ]);
    }
    #[Route('/admin',name: 'app_schedule_admin', methods: ['GET'])]
    public function admin(ScheduleRepository $scheduleRepository): Response
    {
        $user = $this->getUser();
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_schedule_admin', [], Response::HTTP_SEE_OTHER);
        }
